                                        ...
                                        <div class="d-flex align-items-top justify-content-between">
                                            ...
                                            <div class="flex-fill ms-3">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mt-1">
                                                    <div>
                                                        <a class="text-primary" href="{{ route('services') }}">View All<i
                                                                class="bi bi-arrow-up-right  ms-2 fw-semibold d-inline-block"></i></a>
                                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-top justify-content-between">
                                            ...
                                            <div class="flex-fill ms-3">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mt-1">
                                                    <div>
                                                        <a class="text-warning" href="{{ route('application') }}">View All<i
                                                                class="bi bi-arrow-up-right ms-2 fw-semibold d-inline-block"></i></a>
                                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-top justify-content-between">
                                            ...
                                            <div class="flex-fill ms-3">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mt-1">
                                                    <div>
                                                        <a class="text-secondary" href="{{ route('document') }}">View All<i
                                                                class="bi bi-arrow-up-right ms-2 fw-semibold d-inline-block"></i></a>
                                                    </div>
                                            ...
                                            <li class="crm-recent-activity-content">
                                                <div class="d-flex align-items-top">
                                                    ...
                                                    <div class="crm-timeline-content  w-100">
                                                        <span class="fw-semibold">New Blog: </span><span><a
                                                                target="_blank"
                                                                href="https://hetdynamic.com/blog/{{ $blog->slug }}"
                                    ...
                                    <table class="table text-nowrap table-hover border table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="avatar avatar-md rounded-0 border w-50">
                                                        <img src="{{ asset('assets/images/media/media-2.jpg') }}"
                                                            alt="img" class="w-100 object-fit-cover rounded-1">
                                                    </div>
                                                </td>
                                                <td>

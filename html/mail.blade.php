                ...
                <div class="main-mail-container p-2 gap-2 d-flex">
                    <div class="mail-navigation border">
                        <div class="d-grid align-items-top p-3 border-bottom">
                            <button class="btn btn-success d-flex align-items-center justify-content-center" data-bs-toggle="modal" data-bs-target="#mail-Compose">
                    ...
                    <div class="total-mails border">
                        <div class="p-3 d-flex align-items-center border-bottom">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-icon btn-light btn-wave waves-light" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <li>
                                    <div class="d-flex align-items-top">
                                        ...
                                        <div class="flex-fill">
                                            <a href="javascript:void(0);">
                                                <p class="mb-1 fs-12">
                                                    Sujika <span class="float-end text-muted fw-normal fs-11"><span class="me-2"><i class="ri-attachment-2 align-middle fs-12"></i></span>1:32PM</span>
                                                </p>
                                            </a>
                                ...
                                <li>
                                    <div class="d-flex align-items-top">
                                        ...
                                        <div class="flex-fill">
                                            <a href="javascript:void(0);">
                                                <p class="mb-1 fs-12">
                                                    King Berunda <span class="badge bg-success">Promotion</span><span class="float-end text-muted fw-normal fs-11">Yesterday, 10:27AM</span>
                                                </p>
                                            </a>
                                            <p class="mail-msg mb-0">
                                ...
                                <li>
                                    <div class="d-flex align-items-top">
                                        ...
                                        <div class="flex-fill">
                                            <a href="javascript:void(0);">
                                                <p class="mb-1 fs-12">
                                                    Samantha May <span class="badge bg-primary">Social</span><span class="float-end text-muted fw-normal fs-11">24 Oct, 5:45PM</span>
                                                </p>
                                            </a>
                                            <p class="mail-msg mb-0">
                                ...
                                <li>
                                    <div class="d-flex align-items-top">
                                        ...
                                        <div class="flex-fill">
                                            <a href="javascript:void(0);">
                                                <p class="mb-1 fs-12">
                                                    Alex Carey <span class="float-end text-muted fw-normal fs-11">12 Sep, 11:24AM</span>
                                                </p>
                                            </a>
                                            <p class="mail-msg mb-0">
                                ...
                                <li>
                                    <div class="d-flex align-items-top">
                                        ...
                                        <div class="flex-fill">
                                            <a href="javascript:void(0);">
                                                <p class="mb-1 fs-12">
                                                    Dawn Bradshaw <span class="badge bg-danger">Personal</span><span class="float-end text-muted fw-normal fs-11">11 Sep, 10:32AM</span>
                                                </p>
                                            </a>
                                            <p class="fs-12 mb-0">
                                            <p class="mail-msg mb-0">
                                ...
                                <li>
                                    <div class="d-flex align-items-top">
                                        ...
                                        <div class="flex-fill">
                                            <a href="javascript:void(0);">
                                                <p class="mb-1 fs-12">
                                                    Kiara Jah <span class="float-end text-muted fw-normal fs-11">08 Aug, 08:12AM</span>
                                                </p>
                                            </a>
                                            <p class="fs-12 mb-0">
                                            <p class="mail-msg mb-0">
                                ...
                                <li>
                                    <div class="d-flex align-items-top">
                                        ...
                                        <div class="flex-fill">
                                            <a href="javascript:void(0);">
                                                <p class="mb-1 fs-12">
                                                    David Subhman <span class="float-end text-muted fw-normal fs-11">16 July, 05:52PM</span>
                                                </p>
                                            </a>
                                            <p class="fs-12 mb-0">
                                            <p class="mail-msg mb-0">
                    ...
                    <div class="mails-information border">
                        <div class="mail-info-header d-flex flex-wrap gap-2 align-items-center">
                            ...
                            <div class="mail-action-icons">
                                <button class="btn btn-icon btn-light" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Starred">
                                    <i class="ri-star-line"></i>
                                </button>
                                <button class="btn btn-icon btn-light ms-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Archive">
                                    <i class="ri-inbox-archive-line"></i>
                                </button>
                                <button class="btn btn-icon btn-light ms-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Report spam">
                                    <i class="ri-spam-2-line"></i>
                                </button>
                                <button class="btn btn-icon btn-light ms-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete">
                                    <i class="ri-delete-bin-line"></i>
                                </button>
                                <button class="btn btn-icon btn-light ms-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Reply">
                        ...
                        <div class="mail-info-body p-4" id="mail-info-body">
                            ...
                            <div class="mail-attachments mb-4">
                                ...
                                <div class="mt-2 d-flex flex-wrap">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-icon btn-outline-light ms-2 btn-lg mb-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Image_012.jpeg">

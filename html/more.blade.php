                    ...
                    <div class="row">
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="height: 100px; background-color: rgba(255,0,0,0.1);" class="d-flex">
                                        <div class="h-25 d-inline-block" style="width: 120px; background-color: rgba(0,0,255,.1);padding-inline:10px;">Height 25%
                                        </div>
                                        <div class="h-50 d-inline-block" style="width: 120px; background-color: rgba(0,0,255,.1);padding:10px;">Height 50%
                                        </div>
                                        <div class="h-75 d-inline-block" style="width: 120px; background-color: rgba(0,0,255,.1);padding:10px;">Height 75%
                                        </div>
                                        <div class="h-100 d-inline-block" style="width: 120px; background-color: rgba(0,0,255,.1);padding:10px;">Height 100%
                                        </div>
                                        <div class="h-auto d-inline-block" style="width: 120px; background-color: rgba(0,0,255,.1);padding:10px;">Height auto
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                <div class="card-header">
                                    <div class="card-title">
                                        You can also use <span class="text-danger"> max-width: 100%;</span> and <span class="text-danger">max-height: 100%;</span> utilities as needed.
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div style="height: 100px; background-color: rgba(255,0,0,.1);" class="mt-3">
                                        <div class="mh-100" style="width: 100px; height: 200px; background-color: rgba(0,0,255,.1); padding:10px;">
                                            Max-height 100%</div>
                                    </div>
                                </div>
                            </div>

                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0" class="scrollspy-example bg-light p-3 rounded-2" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 col-sm-8">
                                            <div data-bs-spy="scroll" data-bs-target="#navbar-example3" data-bs-smooth-scroll="true" tabindex="0" class="scrollspy-example-2">
                                                <div id="item-1">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2 col-12">
                                                <div id="list-example" class="list-group">
                                                    <a class="list-group-item list-group-item-action" href="#list-item-01">Item 1</a>
                                                    <a class="list-group-item list-group-item-action" href="#list-item-02">Item
                                                        2</a>
                                                    <a class="list-group-item list-group-item-action" href="#list-item-03">Item
                                                        3</a>
                                                    <a class="list-group-item list-group-item-action" href="#list-item-04">Item
                                                        4</a>
                                                </div>
                                            </div>
                                ...
                                <div class="card-body">
                                    <div class="bd-example">
                                        <div class="row">
                                            ...
                                            <div class="col-md-10 col-12">
                                                <div data-bs-spy="scroll" data-bs-target="#simple-list-example" data-bs-offset="0" data-bs-smooth-scroll="true" class="scrollspy-example-4" tabindex="0">

                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-sm btn-icon btn-light" data-bs-dismiss="modal"><i class="ri-close-fill"></i></button>
                                                    <button type="button" class="btn btn-sm btn-success">Create</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <button class="btn btn-sm btn-outline-secondary d-flex align-items-center justify-content-center btn-wave waves-light" data-bs-toggle="modal" data-bs-target="#create-file">
                                        ...
                                        <div class="card custom-card shadow-none bg-light">
                                            <div class="card-body p-3">
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex justify-content-between flex-wrap">
                                                        <div class="file-format-icon">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="svg-warning" viewbox="0 0 24 24"><path opacity="0.3" d="m20 9-7-7H7a3 3 0 0 0-3 3v14a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3Z"></path><path opacity="1" d="M20 9h-5a2 2 0 0 1-2-2V2zm-5 9H9a1 1 0 0 1 0-2h6a1 1 0 0 1 0 2zm0-4H9a1 1 0 0 1 0-2h6a1 1 0 0 1 0 2zm-5-4H9a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2z"></path></svg>
                                                        </div>
                                                        <div>
                                                            <span class="fw-semibold mb-1">
                                                                Docs
                                        ...
                                        <div class="card custom-card shadow-none bg-light">
                                            <div class="card-body p-3">
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex justify-content-between flex-wrap">
                                                        <div class="file-format-icon">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="svg-success" enable-background="new 0 0 24 24" viewbox="0 0 24 24"><circle cx="12" cy="4" r="2" opacity="0.3"></circle><path fill="#b7d7fd" d="M12 6a1.98 1.98 0 0 1-1-.277V8a1 1 0 0 0 2 0V5.723A1.98 1.98 0 0 1 12 6z"></path><path opacity="0.3" d="M17 22H7a3.003 3.003 0 0 1-3-3v-9a3.003 3.003 0 0 1 3-3h10a3.003 3.003 0 0 1 3 3v9a3.003 3.003 0 0 1-3 3z"></path><path opacity="1" d="M14.97 12.243 16.28 7H7.72l1.31 5.243A1 1 0 0 0 10 13h4a1 1 0 0 0 .97-.757z"></path><path fill="#b7d7fd" d="M2 18a1 1 0 0 1-1-1v-2a1 1 0 1 1 2 0v2a1 1 0 0 1-1 1zm20 0a1 1 0 0 1-1-1v-2a1 1 0 1 1 2 0v2a1 1 0 0 1-1 1z"></path><circle cx="9" cy="16" r="1" opacity="1"></circle><circle cx="15" cy="16" r="1" opacity="1"></circle></svg>
                                                        </div>
                                                        <div>
                                                            <span class="fw-semibold mb-1">
                                                                Apps
                                        ...
                                        <div class="card custom-card shadow-none bg-light">
                                            <div class="card-body p-3">
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex justify-content-between flex-wrap">
                                                        <div class="file-format-icon">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="svg-purple" viewbox="0 0 24 24"><path opacity="0.3" d="M17 21H7a3.003 3.003 0 0 1-3-3V8a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v10a3.003 3.003 0 0 1-3 3Z"></path><path opacity="1" d="M19 9H5a3 3 0 0 1 0-6h14a3 3 0 0 1 0 6zm-5 4h-4a1 1 0 0 1 0-2h4a1 1 0 0 1 0 2z"></path></svg>
                                                        </div>
                                                        <div>
                                                            <span class="fw-semibold mb-1">
                                                                Archives
                                        ...
                                        <div class="card custom-card shadow-none bg-light">
                                            <div class="card-body p-3">
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex justify-content-between flex-wrap">
                                                        <div class="file-format-icon">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="svg-pink" viewbox="0 0 24 24"><rect width="9" height="9" x="2" y="2" opacity="1" rx="1"></rect><rect width="9" height="9" x="2" y="13" opacity="0.3" rx="1"></rect><rect width="9" height="9" x="13" y="2" opacity="0.3" rx="1"></rect><rect width="9" height="9" x="13" y="13" opacity="0.3" rx="1"></rect></svg>
                                                        </div>
                                                        <div>
                                                            <span class="fw-semibold mb-1">
                                                                More

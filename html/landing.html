        ...
        <div class="main-content landing-main px-0">
                        ...
                        <div class="row">
                            <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-8">
                                <div class="py-lg-5">
                                    ...
                                    <p class="landing-banner-heading mb-3">Your sure stop place for best theme ends here with <span class="text-secondary">YNEX !</span></p>
                                    <div class="fs-16 mb-5 text-fixed-white op-7">ynex - Now you can use this admin template to design stunning dashboards that will wow your target viewers or users to no end.</div>
                                ...
                                <div class="col-xl-2 col-lg-4 col-md-6 col-sm-6 col-12 mb-3">
                                    <div class="p-3 text-center rounded-2 bg-white border">
                                        <span class="mb-3 avatar avatar-lg avatar-rounded bg-primary-transparent">
                                          ...
                                          <h3 class="fw-semibold mb-0 text-dark">$45.8M</h3>
                                        <p class="mb-1 fs-14 op-7 text-muted ">
                                            Income Earned
                                        </p>
                                    </div>
            ...
            <section class="section " id="about">
                <div class="container text-center">
                    <p class="fs-12 fw-semibold text-success mb-1"><span class="landing-section-heading">CUSTOMIZATION</span></p>
                    <h3 class="fw-semibold mb-2">Designed with precision and well documented</h3>
                    <div class="row justify-content-center">
                        <div class="col-xl-7">
                            <p class="text-muted fs-15 mb-3 fw-normal">ynex comes with multiple customization options that are very easy to implement.</p>
                        </div>
                    </div>
            ...
            <section class="section section-bg " id="our-mission">
                <div class="container text-center">
                    <p class="fs-12 fw-semibold text-success mb-1"><span class="landing-section-heading">OUR MISSION</span></p>
                    <h2 class="fw-semibold mb-2">Our mission consists of 8 major steps.</h2>
                    <div class="row justify-content-center mb-5">
                        <div class="col-xl-7">
                            <p class="text-muted fs-15mb-0 fw-normal">Our mission is to make web design easy, so you can focus on building your brand.</p>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="align-items-top">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-0 text-muted">lorem ipsum, dolor sit var ameto condesetrat aiatel varen or damsenlel verman code Lorem ipsum, dolor sit amet consectetur adipisicing elit</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="section landing-Features" id="features">
                <div class="container text-center">
                    <p class="fs-12 fw-semibold text-success mb-1"><span class="landing-section-heading">Features</span></p>
                    <h2 class="fw-semibold mb-2 text-fixed-white ">Features Used in YNEX</h2>
                    <div class="row justify-content-center">
                        <div class="col-xl-7">
                        ...
                        <div class="justify-content-center">
                            <div class="">
                                <div class="feature-logos mt-sm-5 flex-wrap">
                                    ...
                                    <div class="ms-sm-5 ms-2 text-center">
                                        <img src="../assets/images/media/landing/web/6.png" alt="image" class="featur-icon">
            ...
            <section class="section landing-testimonials section-bg" id="testimonials">
                <div class="container text-center">
                    <p class="fs-12 fw-semibold text-success mb-1"><span class="landing-section-heading">TESTIMONIALS</span></p>
                            ...
                            <div class="swiper-slide">
                                <div class="card custom-card testimonial-card">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <span class="text-muted">- Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum autem quaerat distinctio  --</span>
                                        </div>
            ...
            <section class="section  section-bg" id="team">
                <div class="container text-center">
                    <p class="fs-12 fw-semibold text-success mb-1"><span class="landing-section-heading">OUR TEAM</span></p>
                    <h3 class="fw-semibold mb-2">Great things in business are done by a team.</h3>
                    <div class="row justify-content-center">
                        <div class="col-xl-7">
                            <p class="text-muted fs-15 mb-5 fw-normal">Our team consists of highly qulified employees that works hard to raise company standards.</p>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card text-center team-card ">
                                <div class="card-body p-5">
                                    ...
                                    <p class="fw-semibold fs-17 mb-0 text-default">Andrew garfield</p>
                        ...
                        <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card text-center team-card ">
                                <div class="card-body p-5">
                                    ...
                                    <p class="fw-semibold fs-17 mb-0 text-default">Json Taylor</p>
                                    <span class="text-muted fs-14 text-primary fw-semibold">Web Designer</span>
                                    <p class="text-muted mt-2 fs-13"> Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                                    <div class="mt-2">
                                        <a href="profile.html" class="btn btn-light" target="_blank">View profile</a>
                                    </div>
                        ...
                        <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card text-center team-card ">
                                <div class="card-body p-5">
                                    ...
                                    <span class="text-muted fs-14 text-primary fw-semibold">HR</span>
                                    <p class="text-muted mt-2 fs-13"> Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                                    <div class="mt-2">
                                        <a href="profile.html" class="btn btn-light" target="_blank">View profile</a>
                                    </div>
            ...
            <section class="section  " id="pricing">
                <div class="container text-center">
                    ...
                    <h3 class="fw-semibold mb-2">ynex comes with most affordable pricing range.</h3>
                    <div class="row justify-content-center">
                        <div class="col-xl-9">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="p-4">
                                                ...
                                                <div class="py-4 d-flex align-items-center justify-content-center">
                                                    ...
                                                    <div class="text-end ms-5">
                                                        ...
                                                        <p class="text-muted fs-11 fw-semibold mb-0">per month</p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                            <div class="p-4 pricing-offer overflow-hidden">
                                                ...
                                                <div class="d-grid">
                                                    <button class="btn btn-primary btn-wave shadow">Get Started</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane p-0" id="pricing-yearly-pane" role="tabpanel" aria-labelledby="pricing-yearly" tabindex="0">
                                    <div class="row">
                                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12 border-end border-inline-end-dashed">
                                            <div class="p-4">
                                                <h6 class="fw-semibold text-center">BASIC</h6>
                                                <div class="py-4 d-flex align-items-center justify-content-center">
                                                    ...
                                                    <div class="text-end ms-5">
                                                        ...
                                                        <p class="text-muted fs-11 fw-semibold mb-0">per year</p>
                                                    </div>
                                                </div>
                                                <ul class="list-unstyled text-center fs-12 px-3 pt-3 mb-0">
                                                    <li class="mb-3">
            ...
            <section class="section section-bg" id="faq">
                <div class="container text-center">
                    <p class="fs-12 fw-semibold text-success mb-1"><span class="landing-section-heading">F.A.Q</span></p>
            ...
            <section class="section" id="contact">
                <div class="container text-center">
                    <p class="fs-12 fw-semibold text-success mb-1"><span class="landing-section-heading">CONTACT US</span></p>

                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                                                <ul class="navbar-nav">
                                                    ...
                                                    <li class="nav-item dropdown">
                                                        <a class="nav-link dropdown-toggle" href="javascript:void(0);" id="navbarDropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                                                            Dropdown link
                                                        </a>
                                ...
                                <div class="card-body">
                                    ...
                                    <nav class="navbar navbar-expand-lg navbar-secondary mb-3">
                                        <div class="container-fluid">
                                            ...
                                            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarColor05" aria-controls="navbarColor05" aria-expanded="false" aria-label="Toggle navigation">
                                                <span class="navbar-toggler-icon"></span>
                                            </button>
                                    ...
                                    <nav class="navbar navbar-expand-lg navbar-dark">
                                        <div class="container-fluid">
                                            <a aria-label="anchor" class="navbar-brand" href="javascript:void(0);"><img src="../assets/images/brand-logos/toggle-logo.png" alt=""></a>
                                            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarColor06" aria-controls="navbarColor06" aria-expanded="false" aria-label="Toggle navigation">
                                                <span class="navbar-toggler-icon"></span>
                                            </button>
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="collapse navbar-collapse" id="navbarScroll">
                                                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                                                    ...
                                                    <li class="nav-item dropdown">
                                                        <a class="nav-link dropdown-toggle" href="javascript:void(0);" id="navbarScrollingDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                                            Link
                                                        </a>
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link disabled" href="javascript:void(0);" tabindex="-1" aria-disabled="true">Link</a>
                                                    </li>
                                                </ul>
                                ...
                                <div class="card-body">
                                    <nav class="navbar bg-light fixed-top">
                                        <div class="container-fluid">
                                            ...
                                            <button aria-label="button" class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar">
                                                <span class="navbar-toggler-icon"></span>
                                            </button>
                                                ...
                                                <div class="offcanvas-body">
                                                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                                        ...
                                                        <li class="nav-item dropdown mb-3">
                                                            <a class="nav-link dropdown-toggle" href="javascript:void(0);" id="offcanvasNavbarDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                                                Dropdown
                                                            </a>

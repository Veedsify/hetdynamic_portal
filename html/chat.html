                ...
                <div class="main-chart-wrapper p-2 gap-2 d-lg-flex">
                    <div class="chat-info border">
                        ...
                        <div class="d-flex align-items-center justify-content-between w-100 p-3 border-bottom">
                            ...
                            <div class="dropdown">
                                <button aria-label="button" class="btn btn-icon btn-secondary-light btn-wave waves-light" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div class="chat-search p-3 border-bottom">
                            <div class="input-group">
                                <input type="text" class="form-control bg-light border-0" placeholder="Search Chat" aria-describedby="button-addon2">
                        ...
                        <ul class="nav nav-tabs tab-style-2 nav-justified mb-0 border-bottom d-flex" id="myTab1" role="tablist">
                            <li class="nav-item border-end me-0" role="presentation">
                                <button class="nav-link active h-100" id="users-tab" data-bs-toggle="tab" data-bs-target="#users-tab-pane" type="button" role="tab" aria-controls="users-tab-pane" aria-selected="true"><i class="ri-history-line me-1 align-middle d-inline-block"></i>Recent</button>
                            </li>
                            <li class="nav-item border-end me-0" role="presentation">
                                <button class="nav-link h-100" id="groups-tab" data-bs-toggle="tab" data-bs-target="#groups-tab-pane" type="button" role="tab" aria-controls="groups-tab-pane" aria-selected="false"><i class="ri-group-2-line me-1 align-middle d-inline-block"></i>Groups</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link h-100" id="calls-tab" data-bs-toggle="tab" data-bs-target="#calls-tab-pane" type="button" role="tab" aria-controls="calls-tab-pane" aria-selected="false"><i class="ri-phone-line me-1 align-middle d-inline-block"></i>Calls</button>
                            </li>
                        </ul>
                                            ...
                                            <div class="d-flex align-items-top">
                                                ...
                                                <div class="flex-fill">
                                                    <p class="mb-0 fw-semibold">
                                                        Sujika <span class="float-end text-muted fw-normal fs-11">1:32PM</span>
                                                    </p>
                                                    <p class="fs-12 mb-0">
                                    ...
                                    <li class="checkforactive">
                                        <a href="javascript:void(0);" onclick="changeTheInfo(this,'Emiley Jackson','2','online')">
                                            <div class="d-flex align-items-top">
                                                ...
                                                <div class="flex-fill">
                                                    <p class="mb-0 fw-semibold">
                                                        Emiley Jackson <span class="float-end text-muted fw-normal fs-11">12:24PM</span>
                                                    </p>
                                                    <p class="fs-12 mb-0 chat-msg-typing ">
                                                        <span class="chat-msg text-truncate">Typing...</span>
                                                        <span class="chat-read-icon float-end align-middle"><i class="ri-check-double-fill"></i></span>
                                                        <span class="badge bg-success-transparent rounded-circle float-end">2</span>
                                                    </p>
                                                </div>
                                            </div>
                                        </a>
                                    ...
                                    <li class="chat-msg-unread checkforactive">
                                        <a href="javascript:void(0);" onclick="changeTheInfo(this,'McGreggor','10','online')">
                                            <div class="d-flex align-items-top">
                                                ...
                                                <div class="flex-fill">
                                                    <p class="mb-0 fw-semibold">
                                                        McGreggor <span class="float-end text-muted fw-normal fs-11">1:16PM</span>
                                                    </p>
                                                    <p class="fs-12 mb-0">
                                    ...
                                    <li class="checkforactive">
                                        <a href="javascript:void(0);" onclick="changeTheInfo(this,'Alissa','8','online')">
                                            <div class="d-flex align-items-top">
                                                ...
                                                <div class="flex-fill">
                                                    <p class="mb-0 fw-semibold">
                                                        Alissa <span class="float-end text-muted fw-normal fs-11">12:45PM</span>
                                                    </p>
                                                    <p class="fs-12 mb-0">
                                    ...
                                    <li class="chat-inactive checkforactive">
                                        <a href="javascript:void(0);" onclick="changeTheInfo(this,'Andreas','11','offline')">
                                            <div class="d-flex align-items-top">
                                                ...
                                                <div class="flex-fill">
                                                    <p class="mb-0 fw-semibold">
                                                        Andreas <span class="float-end text-muted fw-normal fs-11">11:54AM</span>
                                                    </p>
                                                    <p class="fs-12 mb-0">
                                    ...
                                    <li class="chat-inactive checkforactive">
                                        <a href="javascript:void(0);" onclick="changeTheInfo(this,'Melissa Sean','3','offline')">
                                            <div class="d-flex align-items-top">
                                                ...
                                                <div class="flex-fill">
                                                    <p class="mb-0 fw-semibold">
                                                        Melissa Sean <span class="float-end text-muted fw-normal fs-11">9:45AM</span>
                                                    </p>
                                                    <p class="fs-12 mb-0">
                                    ...
                                    <li class="chat-inactive checkforactive">
                                        <a href="javascript:void(0);" onclick="changeTheInfo(this,'Samantha Paul','6','offline')">
                                            <div class="d-flex align-items-top">
                                                ...
                                                <div class="flex-fill">
                                                    <p class="mb-0 fw-semibold">
                                                        Samantha Paul <span class="float-end text-muted fw-normal fs-11">8:31AM</span>
                                                    </p>
                                                    <p class="fs-12 mb-0">
                                    ...
                                    <li class="chat-inactive checkforactive">
                                        <a href="javascript:void(0);" onclick="changeTheInfo(this,'Megan Fox','4','offline')">
                                            <div class="d-flex align-items-top">
                                                ...
                                                <div class="flex-fill">
                                                    <p class="mb-0 fw-semibold">
                                                        Megan Fox <span class="float-end text-muted fw-normal fs-11">7:23AM</span>
                                                    </p>
                                                    <p class="fs-12 mb-0">
                                    ...
                                    <li class="chat-inactive checkforactive">
                                        <a href="javascript:void(0);" onclick="changeTheInfo(this,'Nicholas Sams','13','offline')">
                                            <div class="d-flex align-items-top">
                                                ...
                                                <div class="flex-fill">
                                                    <p class="mb-0 fw-semibold">
                                                        Nicholas Sams <span class="float-end text-muted fw-normal fs-11">10:22AM</span>
                                                    </p>
                                                    <p class="fs-12 mb-0">
                                    ...
                                    <li class="chat-inactive checkforactive">
                                        <a href="javascript:void(0);" onclick="changeTheInfo(this,'Pope Johnson','15','offline')">
                                            <div class="d-flex align-items-top">
                                                ...
                                                <div class="flex-fill">
                                                    <p class="mb-0 fw-semibold">
                                                        Pope Johnson <span class="float-end text-muted fw-normal fs-11">9:10AM</span>
                                                    </p>
                                                    <p class="fs-12 mb-0">
                                    ...
                                    <li class="checkforactive">
                                        <a href="javascript:void(0);" onclick="changeTheInfo(this,'Family Together &#128525;','18','online')">
                                            <div class="d-flex align-items-top">
                                                ...
                                                <div class="flex-fill">
                                                    <p class="mb-0 fw-semibold">
                                                        Family Together &#128525; <span class="float-end text-muted fw-normal fs-11">12:24PM</span>
                                                    </p>
                                                    <p class="fs-12 mb-0 chat-msg-typing ">
                                    ...
                                    <li class="chat-msg-unread checkforactive">
                                        <a href="javascript:void(0);" onclick="changeTheInfo(this,'Work Buddies','19','online')">
                                            <div class="d-flex align-items-top">
                                                ...
                                                <div class="flex-fill">
                                                    <p class="mb-0 fw-semibold">
                                                        Work Buddies <span class="float-end text-muted fw-normal fs-11">1:16PM</span>
                                                    </p>
                                                    <p class="fs-12 mb-0">
                                                        <span class="chat-msg text-truncate"><span class="group-indivudial">Rams:</span>Happy to be part of
                                                            this group</span>
                                                        <span class="chat-read-icon float-end align-middle"><i class="ri-check-double-fill"></i></span>
                                                    </p>
                                                </div>
                                    ...
                                    <li class="chat-inactive checkforactive">
                                        <a href="javascript:void(0);" onclick="changeTheInfo(this,'Friends Forever &#128526;','20','offline')">
                                            <div class="d-flex align-items-top">
                                                ...
                                                <div class="flex-fill">
                                                    <p class="mb-0 fw-semibold">
                                                        Friends Forever &#128526; <span class="float-end text-muted fw-normal fs-11">3 days
                                                            ago</span>
                                                    </p>
                                                    <p class="fs-12 mb-0">
                                    ...
                                    <li class="chat-inactive checkforactive">
                                        <a href="javascript:void(0);" onclick="changeTheInfo(this,'Social Media Deals','21','offline')">
                                            <div class="d-flex align-items-top">
                                                ...
                                                <div class="flex-fill">
                                                    <p class="mb-0 fw-semibold">
                                                        Social Media Deals <span class="float-end text-muted fw-normal fs-11">5 days
                                                            ago</span>
                                                    </p>
                                                    <p class="fs-12 mb-0">
                                    ...
                                    <li class="chat-inactive checkforactive">
                                        <a href="javascript:void(0);" onclick="changeTheInfo(this,'Apartment Group','22','offline')">
                                            <div class="d-flex align-items-top">
                                                ...
                                                <div class="flex-fill">
                                                    <p class="mb-0 fw-semibold">
                                                        Apartment Group <span class="float-end text-muted fw-normal fs-11">12 days
                                                            ago</span>
                                                    </p>
                                                    <p class="fs-12 mb-0">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-fill my-auto">
                                                <p class="mb-0 fw-semibold">
                                                    Azimo Peter
                                                    <span class="ms-1 incoming-call-failed"><i class="ti ti-arrow-up-right"></i></span>
                                                </p>
                                                <p class="fs-12 mb-0">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="chat-item-end">
                                    <div class="chat-list-inner">
                                        <div class="me-3">
                                            <span class="chatting-user-info">
                                                <span class="msg-sent-time"><span class="chat-read-mark align-middle d-inline-flex"><i class="ri-check-double-line"></i></span>11:50PM</span> You
                                            </span>
                                            <div class="main-chat-msg">
                                                <div>
                                ...
                                <li class="chat-item-end">
                                    <div class="chat-list-inner">
                                        <div class="me-3">
                                            <span class="chatting-user-info">
                                                <span class="msg-sent-time"><span class="chat-read-mark align-middle d-inline-flex"><i class="ri-check-double-line"></i></span>11:52PM</span> You
                                            </span>
                                            <div class="main-chat-msg">
                                                <div>
                                ...
                                <li class="chat-item-end">
                                    <div class="chat-list-inner">
                                        <div class="me-3">
                                            ...
                                            <div class="main-chat-msg">
                                                <div class="">
                                                    <a aria-label="anchor" href="javascript:void(0)" class="text-fixed-white"><i class="ri-play-circle-line align-middle"></i></a>
                                                    <span class="mx-1">
                                                    ...
                                                    <a aria-label="anchor" href="javascript:void(0)" class="text-fixed-white"><i class="ri-download-2-line align-middle"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="chat-user-profile">
                    ...
                    <div class="chat-user-details border" id="chat-user-details">
                        ...
                        <div class="text-center mb-5">
                            ...
                            <p class="text-center mb-0">
                                <button type="button" aria-label="button" class="btn btn-icon rounded-pill btn-primary-light"><i class="ri-phone-line"></i></button>
                                <button type="button" aria-label="button" class="btn btn-icon rounded-pill btn-primary-light ms-2"><i class="ri-video-add-line"></i></button>
                                <button type="button" aria-label="button" class="btn btn-icon rounded-pill btn-primary-light ms-2"><i class="ri-chat-1-line"></i></button>
                            </p>
                        </div>
                        <div class="mb-5">

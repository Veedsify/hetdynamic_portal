                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <p><span class="text-danger">.gx-*</span> classes can be used to control the
                                        ...
                                        example,
                                        in the following example we’ve increased the padding with <span class="text-danger">.px-4</span>:
                                    </p>
                                    ...
                                    <p>An alternative solution is to add a wrapper around the <span class="text-danger">.row</span> with the <span class="text-danger">.overflow-hidden</span> class:
                                    </p>
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <p><span class="text-danger">.gy-*</span> classes can be used to control the
                                        ...
                                        .row
                                        at the end of a page. If this occurs, you add a wrapper around <span class="text-danger">.row</span> with the
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <p>The gutters between columns in our predefined grid classes can be removed
                                        with
                                        <span class="text-danger">.g-0</span>. This removes the negative <span class="text-danger">margins</span> from <span class="text-danger">.row
                                        </span>and the horizontal <span class="text-danger">padding</span>
                                        from all immediate children columns.
                                    </p>
                                    <p>Need an edge-to-edge design? Drop the parent <span class="text-danger">.container</span> or <span class="text-danger">.container-fluid</span> and
                                        add <span class="text-danger">.mx-0</span> to the <span class="text-danger">.row</span> to prevent overflow.
                                    </p>

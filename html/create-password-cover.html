                ...
                <div class="col-xxl-6 col-xl-7 col-lg-7 col-md-7 col-sm-8 col-12">
                    <div class="p-5">
                        ...
                        <div class="btn-list">
                            ...
                            <button class="btn btn-icon btn-primary-light"><i class="ri-facebook-fill"></i></button>
                            <button class="btn btn-icon btn-info-light"><i class="ri-twitter-fill"></i></button>
                        </div>
                        ...
                        <div class="row gy-3">
                            <div class="col-xl-12 mt-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <button onclick="createpassword('create-password',this)" class="btn btn-light" type="button"><i class="ri-eye-off-line align-middle"></i></button>
                                </div>
                            </div>
                            <div class="col-xl-12 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <button onclick="createpassword('create-confirmpassword',this)" class="btn btn-light" type="button"><i class="ri-eye-off-line align-middle"></i></button>
                                </div>
                                <div class="mt-2">
                        ...
                        <div class="text-center">
                            <p class="fs-12 text-muted mt-4">Back to home ? <a href="index.html" class="text-primary">Click Here</a></p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="text-fixed-white text-center p-5 d-flex align-items-center justify-content-center">
                                    <div>
                                        ...
                                        <h6 class="fw-semibold text-fixed-white">Create Password</h6>
